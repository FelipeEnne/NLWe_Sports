...
import {
  converHourStringToMinutes,
  converMinutesToHourString,
...
app.post("/games/:id/ads", async (request, response) => {
  ...
  const ad = await prisma.ad.create({
    data: {
      ...
      hoursStart: converHourStringToMinutes(body.hoursStart),
      hoursEnd: converHourStringToMinutes(body.hoursEnd),
